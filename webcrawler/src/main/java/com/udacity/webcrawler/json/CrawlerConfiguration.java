 ...
 */
@JsonDeserialize(builder = CrawlerConfiguration.Builder.class) // implementing following steps as mentioned in the udacity dashboard/ course
public final class CrawlerConfiguration {
  ...
  public static final class Builder {
     ...
     */
    @JsonProperty("startPages") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("ignoredUrls") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     * @param patterns one or more regular expressions that define a valid {@link Pattern}.
     */
    @JsonProperty("ignoredWords") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("parallelism") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("implementationOverride") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("maxDepth") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("timeoutSeconds") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("popularWordCount") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("profileOutputPath") // implementing following steps as mentioned in the udacity dashboard/ course
     ...
     */
    @JsonProperty("resultPath") // implementing following steps as mentioned in the udacity dashboard/ course
